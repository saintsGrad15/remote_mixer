...
def init_midi():
    ...
    try:
        ...
        if port_index is not None:
            ...
            print(f"Warning: MIDI output interface '{midi_interface_out}' not found. Available ports: {available_ports}")
        ...
        if midi_interface_in:
            ...
            if port_index is not None:
                ...
                print(f"Warning: MIDI input interface '{midi_interface_in}' not found. Available ports: {available_in_ports}")
                # Open virtual port as fallback
